# Generated by Django 3.1.7 on 2021-04-15 21:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('final_score', models.CharField(blank=True, max_length=20, null=True, verbose_name='Итоговый счет')),
                ('date', models.DateField(verbose_name='Дата')),
                ('weather', models.CharField(blank=True, max_length=30, null=True, verbose_name='Погода')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.CharField(blank=True, max_length=50, null=True, verbose_name='Веб сайт')),
                ('team_tactics', models.CharField(blank=True, max_length=50, null=True, verbose_name='Тактика')),
                ('contract', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='main.contract', verbose_name='Контракт')),
                ('football_club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coaches', to='main.footballclub', verbose_name='Тренера')),
            ],
            options={
                'verbose_name': 'Тренер',
